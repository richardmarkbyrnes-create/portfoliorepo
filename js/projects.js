...
window.PROJECTS = {
  ...
  'ask-ai': {
    ...
    paragraphs: [
      'User research and product teams were sitting on a goldmine of customer insights, from weekly sales calls to support logs, but the sheer volume made it impossible to digest. When a product manager needed to know “What are users saying about our onboarding experience?” they had to spend hours searching, reading, and synthesising. We needed a conversational interface that felt as easy as chatting with a colleague, while maintaining the rigour and trust required for serious UX and product decisions.',
      'We designed Ask Insights, an intuitive AI chat companion that lets users query their entire database of customer calls, feedback, and support tickets in plain English. Instead of manually digging through endless transcripts, product teams can simply ask a question and get a synthesised, cited answer in seconds.',
  ...
  'customer-insights': {
    ...
    paragraphs: [
      ...
      'UX researchers and product teams often struggle to turn research findings into collaborative action because insights live in static PDFs or isolated databases. We designed Canvas Insights, an on-canvas Miro experience that lets users pull rich, interactive insight card components directly onto their collaborative boards. Engineered to adapt to different use cases and personas, these cards seamlessly integrate into tables, kanban boards, and mind maps, turning raw data into active, collaborative building blocks.',
  ...
  navigation: {
    ...
    paragraphs: [
      ...
      'As a product scales, its navigation must grow with it. We led the redesign of the core navigation interface for Cashbook, a financial management tool for accountants. The goal was twofold: drastically improve daily workflow efficiency so accountants could digest complex financial data faster, while simultaneously restructuring the information architecture to seamlessly accommodate future multi-product add-ons.',
  ...
  visualisations: {
    ...
    paragraphs: [
      ...
      'Accounting software is notoriously dense, often burying crucial business trends under endless rows of spreadsheet data. We designed visual data dashboards that translate raw financial ledgers into high-level, actionable insights for managers. By surfacing key performance indicators like cash flow, revenue trends, and upcoming expenses at a glance, we transformed how business leaders monitor and steer their financial health.',
  ...
  'design-systems': {
    ...
    paragraphs: [
      ...
      'Designing consistent developer tools at scale requires an ironclad, highly efficient foundation. We led the maintenance and optimisation of the Fiori Tools Figma libraries and design system, establishing a robust framework of over 200 components. By structuring the system to dynamically support more than 10 distinct developer colour themes — from high-contrast light modes to community-favourite dark modes — we bridged the gap between our design files and the production VS Code environment, making it seamless for both designers and engineers to build new features.',
