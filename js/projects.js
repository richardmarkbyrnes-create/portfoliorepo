...
window.PROJECTS = {
  ...
  'ask-ai': {
    ...
    paragraphs: [
      ...
      'Sifting through thousands of customer feedback loops to find specific trends can take teams hours, if not days. We designed Ask Insights, an intuitive AI chat companion that lets users query their entire database of customer calls, feedback, and support tickets in plain English. Instead of manually digging through endless transcripts, product teams can simply ask a question and get a synthesized, cited answer in seconds.',
